...
private:
  unsigned convertToAVX(unsigned BaseOpcode) const {
    switch (BaseOpcode) {
      case X86::PANDrr:   return X86::VPANDrr;
      case X86::PORrr:    return X86::VPORrr;
      case X86::PXORrr:   return X86::VPXORrr;
      case X86::ANDPSrr:  return X86::VANDPSrr;
      case X86::ORPSrr:   return X86::VORPSrr;
      case X86::XORPSrr:  return X86::VXORPSrr;
      case X86::PANDNrr:  return X86::VPANDNrr;
      case X86::ANDPDrr:  return X86::VANDPDrr;
      case X86::ORPDrr:   return X86::VORPDrr;
      case X86::XORPDrr:  return X86::VXORPDrr;
      default:            return 0;
    }
  }
};
